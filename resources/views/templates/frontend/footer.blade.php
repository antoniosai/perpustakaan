<footer id="footer" class="clearfix">
  <div id="footer-widgets">
      ...
      <div id="footer-wrapper">
        ...
        <div class="col-sm-6 col-md-4">
          <div id="search-3" class="widget widgetFooter widget_search"><h4 class="widgettitle">Pencarian</h4>

            <div class="form-group">
                <label class="control-label">Tuliskan kamar yang ingin Anda cari</label>
                <div class="input-group">
